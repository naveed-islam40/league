  ...
  return (
    <>
      <button
        ...
        className="hidden md:block uppercase font-semibold text-[14px] text-white bg-[#3076B1] dark:bg-[#4A9FE7] rounded-[6px] p-[12px]"
      >
        Add assignment
      </button>
                      ...
                      <div className="absolute top-0 left-0 w-full mt-1 h-[100vh] pb-40 overflow-y-scroll">
                        <div className="fixed z-30 w-full bg-white">
                          ...
                          <div className="flex justify-between py-4 px-6 ">
                            <p className="nun font-bold text-[18px] text-[#14142B]">
                              Add Assignment
                            </p>
                            <Image
                        ...
                        <div className="pl-6 pr-8 pb-10 mt-20">
                          ...
                          <div className="flex gap-5 mt-6">
                            ...
                            <div className="w-[30%]">
                              ...
                              />
                              <button className="mt-3 bg-[#EFEFEF99] rounded-[6px] py-[5px] px-[10px] flex gap-4 font-normal text-[#121212] text-[14px]">
                                Account Introduction
                                <RxCross2 className="text-[#7A7B7C] self-center text-[14px] mt-[1px]" />
                              </button>
                            </div>
                            <SelectContent />
                          ...
                          <div className="mt-10">
                            <p className="font-normal text-[#3D4349] text-[14px]">
                              User(s) Assigned *
                            ...
                            <div className="flex gap-2 mt-5">
                              <button className="bg-[#EFEFEF99] rounded-[6px] py-[5px] px-[10px] flex gap-4 font-normal text-[#121212] text-[14px]">
                                Keith Wayman
                                <RxCross2 className="text-[#7A7B7C] self-center text-[14px] mt-[1px]" />
                              </button>
                              <button className="bg-[#EFEFEF99] rounded-[6px] py-[5px] px-[10px] flex gap-4 font-normal text-[#121212] text-[14px]">
                          ...
                          <div className="xl:flex gap-10 mt-6">
                            <div className="flex gap-3">
                              <div className="">
                                ...
                                <div className=" w-[300px] border-[1px] border-[#D9D9D9] rounded-[5px] py-[13px] px-[15px]  mt-2">
                                  <CalendarPopup />
                                </div>
                              </div>
                              ...
                              <div className="flex gap-2  mt-11">
                                ...
                                <p className=" font-normal text-[#121212] text-[12px] mt-[2px]">
                                  Recurring Task
                                </p>
                              </div>
                            </div>
                            ...
                            <div>
                              <div className="flex gap-2 self-center mt-[22px]">
                                <p className="self-center font-normal text-[#121212] text-[12px] mt-3">
                                  Recurring Task
                                </p>
                            ...
                            <div className="flex gap-5">
                              ...
                              <div className="">
                                ...
                                <div className=" w-[200px] border-[1px] border-[#D9D9D9] rounded-[5px] py-[13px] px-[15px]  mt-2">
                                  <CalendarPopup />
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="mt-5">
                            <p className="font-bold text-[16px] text-[#3D4349]">
                              Notifications Settings
                            </p>
                            <p className="font-normal text-[12px] text-[#3D4349] mt-1">
                            ...
                            <div className="lg:flex gap-2">
                              <div className="flex gap-2 self-center mt-3">
                                <input type="checkbox" className="mt-[2px] " />
                                <p className=" font-normal text-[#121212] text-[14px]">
                                  Remind User
                                </p>
                              </div>
                              <div className="w-[90px]">
                              ...
                              <p className="self-center mt-3 font-normal text-[#121212] text-[14px]">
                                day(s) and
                              </p>
                              <div className="w-[90px]">
                                <SelectMenu
                          ...
                          <div className="flex justify-end gap-5 mt-5">
                            ...
                            <button className="font-semibold text-white text-[14px] bg-[#3076B1] hover:bg-[#18459D]  rounded-[6px] py-3 px-4 uppercase">
                              ADD
                            </button>
                          </div>
                        </div>
