...
export default function SelectContent() {
  ...
  return (
    <>
      ...
      className="mt-11  font-semibold text-[14px] text-[#3076B1] dark:text-[#4A9FE7]  cursor-pointer">
        Select Policies
      </span>
                ...
                >
                  <Dialog.Panel className="pointer-events-auto relative w-full">
                    <Transition.Child
                      ...
                      leaveTo="opacity-0"
                    >
                      <div className="dark:bg-black absolute top-0 left-0 w-full mt-1 h-[100vh] pb-48 overflow-y-scroll ">
                        <div className="fixed w-full bg-white dark:bg-black  z-20">
                          <Image
                          ...
                          <div className="flex justify-between py-4 px-6 ">
                            <div>
                              ...
                              <p className="nun font-normal text-[12px] mt-1 w-[90%]">
                    ...
                    <div className="flex w-full h-[70vh] flex-col overflow-y-scroll bg-white dark:bg-black shadow-xl"></div>
