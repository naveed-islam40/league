...
export default function Duplicate() {
  ...
  return (
    <>
      ...
      />
      <Transition.Root show={adds} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={setAdds}>
          <Transition.Child
            as={Fragment}
                ...
                >
                  <Dialog.Panel className="pointer-events-auto relative w-full">
                    <Transition.Child
                      ...
                      leaveTo="opacity-0"
                    >
                      <div className=" absolute top-0 left-0 w-full dark:bg-black mt-1 h-[100vh] overflow-y-scroll pb-40">
                        <div className="fixed bg-white dark:bg-black z-30 w-full">
                          <Image
...
<p className="font-normal text-[10px] bg-[#EEEDED]  text-[#121F2C] p-3">
                                        ...
                                        Roles are used to provide specific
                                        viewing and/or editing rights for this
                                        user.
                                      </p>
                                    </div>
                                  </div>
