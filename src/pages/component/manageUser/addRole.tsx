  ...
  return (
    <>
      <button
        ...
        className="font-semibold text-white text-[14px] bg-[#3076B1] dark:bg-[#4a9fe7] hover:bg-[#18459D] rounded-[6px] p-[11px] uppercase"
      >
        add new role
      </button>

      <Transition.Root show={addRole} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={setAddRole}>
          <Transition.Child
            as={Fragment}
                      ...
                      <div className="dark:bg-black absolute top-0 left-0 w-full mt-1 h-[100vh] pb-40 overflow-y-scroll">
                        <div className="fixed z-30 bg-white dark:bg-black w-full">
                          ...
                          <div className="flex justify-between p-4">
                            <p className="nun font-bold text-[20px] text-[#14142B] dark:text-white">
                              Add New Role
                            </p>
                            <Image
