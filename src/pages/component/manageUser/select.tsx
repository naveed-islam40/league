...
const SelectMenu: React.FC<DropdownMenuProps> = ({
  options,
  selectedType,
  onSelectType,
}) => {
  ...
  return (
    <div className="relative inline-block text-left w-full">
      <button
        ...
        className=" flex justify-between font-normal text-[14px] outline-none w-full bg-white border-[1px] border-[#D9D9D9] rounded-[5px] py-[12px] px-[15px]  mt-2"
      >
        {selectedType}
