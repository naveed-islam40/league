...
export default function PublishSetting3() {
                        ...
                        <div className="fixed z-30 w-full rounded-t-[12px] md:rounded-none dark:bg-black bg-white">
                          ...
                          <div className="px-6 pb-10 mt-28">
                            ...
                            <div className="mt-5 md:flex gap-5">
                              <p className="dark:text-white mt-[6px] font-normal text-[14px] md:w-[20%] lg:w-[15%] xl:w-[10%] self-center">
                                New Content Label
                              </p>
                              <div className="md:w-[30%]">
                               <input type="text" className=" w-full border-[1px] border-[#D9D9D9] rounded-[5px] py-[13px] px-[15px]  mt-2" />           
                              </div>
                            </div>

                            <div className="mt-10">
                              <p className="font-semibold text-[14px] border-b-[2px] border-[#f2f2f2] pb-2">
                              ...
                              <p className="font-normal text-[14px] ml-5 mt-2 dark:text-white">
