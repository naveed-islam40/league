...
import DropdownMenu from "../discussion/DropDown";
...
export default function PublishSetting() {
  ...
  const sortOptions = [
    "Mark as Draft Content",
    "Mark as Final Content",
    "",
  ];
              ...
              <div className="pointer-events-none fixed inset-x-0 bottom-0 flex max-h-full">
                ...
                >
                  <Dialog.Panel className="pointer-events-auto relative w-full">
                    ...
                    >
                      <div className="dark:bg-black absolute top-0 left-0 w-full mt-1 h-[100vh] pb-52 overflow-y-scroll">
                        <div className="fixed z-30 w-full rounded-t-[12px] md:rounded-none dark:bg-black bg-white">
                          ...
                          <div className="flex justify-between py-4 px-6 ">
                           <div>
                            ...
                            <p className="nun font-normal text-[12px] dark:text-white">
                              Note: Your selection will override status for the selected content 
                            </p>
                            </div>
                          ...
                          <div className="px-6 pb-10 mt-40 md:mt-32 lg:mt-28">
                            ...
                            <div className="mt-10">
                              <p className=" dark:text-white font-semibold text-[14px] border-b-[2px] border-[#f2f2f2] pb-2">
                    ...
                    <div className="flex w-full h-[65vh] flex-col overflow-y-scroll rounded-t-[12px] md:rounded-none dark:bg-black bg-white shadow-xl"></div>
                  </Dialog.Panel>
                </Transition.Child>
              </div>
            </div>
