...
const initialItems: Item[] = [
  ...
  { title: "1100.12: Board of Director's Duties", showDraft: false },
  { title: "1100.13: Compensation, Reimbursement", showDraft: true },
  { title: "1100.14: Bond and Insurance Coverage", showDraft: false },
  { title: "1100.15: Education and Volunteer Training", showDraft: true },
  { title: "1100.16: Strategic Planning", showDraft: false },
  { title: "1100.17: Audits", showDraft: false },
  { title: "1100.18: Legal Counsel", showDraft: false },
  { title: "1100.19: Code of Ethics and Diversity", showDraft: false },
];

const mainTitle = [
  "Chapter 2000: Administrative"
];
...
export default function ChapterList() {
  ...
  const handleDragOver = (
    ...
    // If dragged over the same item, do nothing
    if (draggingIndex !== index) {
      ...
      // Update the item list and current dragging index
      setItems(newItems);
      setDraggingIndex(index);
    }
  };
  ...
  return (
    <>
      <div className="bg-white dark:bg-black  py-[15px] md:p-[15px] md:rounded-[7px] shadow-sm mt-5 overflow-hidden md:overflow-auto">
            ...
            mainTitle.map((title, index) => (
              <div className="flex justify-between" key={index}>
                ...
                <Image
                  ...
                  width={20}
                  height={20}
                  className="self-center cursor-pointer filter dark:invert mr-4"
        ...
        {accordionOpen && (
          <div>
            <div className="group hidden md:flex justify-between md:hover:bg-[#eeeeee] md:dark:hover:bg-[#242424] border-y-[1px] border-[#f2f2f2] pl-3  md:px-3 md:py-4 mt-5">
              <p className="hidden md:block nun font-medium text-[14px] text-[#3076B1] py-4 md:py-0">
                Policy 1100: Credit Union Culture and Governance
              </p>

              <p className="block md:hidden nun font-medium text-[14px] text-[#3076B1] py-4 md:py-0">
            ...
            <div>
              {items.map((item, index) => (
                // <Link key={index} href={"/cu-policiesView"}>
                <div
                  key={index}
                  draggable
                  ...
                  className={`flex justify-between group p-4 ${
                    draggingIndex === index
                      ...
                      : "hover:bg-[#eeeeee] md:dark:hover:bg-[#242424]  text-[#3076B1]"
                  } ${
                ...
                >
                  ...
                  <div className="hidden md:flex gap-5 invisible md:group-hover:visible">
                    <Link href={"/editPolicy"}>
                      <Image
                        src={"/assets/svg/bx-edit.svg"}
                        alt=""
