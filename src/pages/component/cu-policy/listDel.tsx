  ...
  return (
    <>
      <p
        ...
        className="nun font-normal text-[#FF0033] text-[12px] border-b-[1px] border-[#f2f2f2] hover:bg-[#f2f2f2] p-[10px] cursor-pointer"
      >
        Delete Policies
      </p>
                          ...
                          <div className="flex justify-between py-4 px-6 ">
                            <div>
                              ...
                              <p className="nun font-normal text-[12px] text-black mt-2">
                                Select one or more policies to update published
                                settings.
                              </p>
                            </div>
