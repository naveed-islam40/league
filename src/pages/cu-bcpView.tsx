          ...
          <>
            ...
            <div className="relative mt-8 md:mt-5 md:w-[95%] 2xl:w-[70%] mx-auto">
              <div className="pl-3 md:pl-0 flex justify-between md:justify-end">
                <Link
                  href={"/cu-bcp"}
                  className="  nun font-semibold text-[#121212] text-[14px] flex md:hidden gap-2"
                >
                  <Image
                ...
                <div className="flex justify-end gap-3 md:gap-5 px-3 md:px-0">
                  <Image
                  ...
                  >
                    ...
                    />
                    {dropdownVisible && (
                      <div className="absolute right-0 mt-2 w-72 bg-white shadow-lg z-20 p-3">
                        <p className="nun font-normal text-[14px]">Move to:</p>
                        ...
                        <div className="border-b-[1px] border-[#CCCCCC] pb-2">
                          <p className="nun font-normal text-[#121F2C] text-[12px] mt-3">
                            Chapter 1000: Administrative
                          </p>
                          <p className="nun font-normal text-[#121F2C] text-[12px] ml-5 mt-2">
                            Policy 1100: Credit Union Culture
                          </p>
                          <p className="nun font-normal text-[#121F2C] text-[12px] ml-8 mt-2">
                        ...
                        <div className="pb-2">
                          ...
                          <p className="nun font-normal text-[#121F2C] text-[12px] ml-2 mt-2">
                            Policy 2100: Bank Secrecy Act/Anti-Money Laund..
                          </p>
                        </div>
                        <div className="flex gap-2 justify-end mt-3">
                          <button className="font-semibold text-[#3076B1] text-[14px]">
                            Cancel
                          </button>
                          <button className="font-semibold text-white bg-[#3076B1] px-4 text-[14px] rounded-[6px] p-[10px] uppercase">
                            move
                          </button>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    {moreDropdownVisible && (
                      <div className="absolute right-0 mt-2 w-[330px] bg-white shadow-lg  ">
                        <SelectContent />
                      </div>
                    )}
                  </div>
              ...
              <div className="bg-white rounded-[4px] p-4 mb-10 mt-3 md:mt-0">
                <p className="nun font-semibold text-[#121F2C] text-[16 px] border-b-[1px] border-[#D8D8D8] pb-2">
                ...
                <p className="nun font-semibold text-[12px] text-[#121F2C] mt-5">
                  General Statement
                </p>
                <p className="nun font-normal text-[#121F2C] text-[12px] mt-1">
                  [[CUname]] (Credit Union) is managed by a Board of Directors
                  assisted by committees as set forth in the Credit Unions
                  bylaws and within governance documents (as applicable). 
                </p>
                <p className="nun font-semibold text-[12px] text-[#121F2C] mt-5">
                  Guidelines:
                </p>
                ...
                <div>
                  <p className="nun font-semibold text-[14px] text-[#121F2C] mt-5">
                    1. BOARD OF DIRECTORS
                  </p>
                  <p className="flex gap-2 nun font-normal text-[12px] text-[#121F2C] mt-2">
                    a.
                    <p>
                      The Board of Directors consists of an odd number of
                      directors, at least five in number, who are elected by the
                  ...
                  <p className="flex gap-2 nun font-normal text-[12px] text-[#121F2C] mt-2">
                    b.
                    <p>
                      The Board is ultimately responsible for all the operations
                      of the Credit Union. 
                    </p>
                  </p>
                  ...
                  <p className="nun font-normal text-[12px] text-[#121F2C]  mt-2">
                    The Board of Directors is responsible for the general
                    direction and control of the affairs of the Credit Union.
                  </p>
                  ...
                  <p className="flex gap-2 nun font-normal text-[12px] text-[#121F2C] mt-2">
                    a.
                    <p>
                      The Board shall appoint the following committees to assist
                      it:
                    </p>
                  </p>
                  ...
                  <p className="flex gap-2 nun font-normal text-[12px] text-[#121F2C] mt-2">
                    i.
                    <p>
                      A Supervisory Committee consisting of not less than three
                  ...
                  <p className="flex gap-2 nun font-normal text-[12px] text-[#121F2C] mt-8">
                    b.
                    <p>
                      The Board is ultimately responsible for all the operations
                      of the Credit Union. 
                  ...
                  <p className="flex gap-2 nun font-normal text-[12px] text-[#121F2C] mt-2">
                    i.
                    <p>
                      Where the bylaws so provide, a Credit Committee consisting
                      of an odd number of members of the Credit Union, but which
                      shall not include more than one loan officer.
                    </p>
                  </p>
                  ...
                  <p className="flex gap-2 nun font-normal text-[12px] text-[#121F2C] mt-2">
                    a.
                    <p>
                      The Credit Union will keep a current set of bylaws and
                      minutes of the meetings of the Board and its committees.
                    </p>
                  </p>
                  ...
                  <p className="nun font-normal text-[12px] text-[#121F2C] mt-2">
                    ...
                    committee member subject to the approval of the Credit
                    Unions examiners and bonding company. However, no person
                    shall serve as a director, officer, committee member, or
                    employee of the Credit Union who has been convicted of any
                  ...
                  <p className="nun font-normal text-[12px] text-[#121F2C] mt-2">
                    See Policy 10001, Table 1 for retention schedule of
                    corporate records.
                  </p>
