...
export default function ConfirmPassword() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
      const token = "This_is_a_dummy_token"
      const response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_BASE_URL}/api/v1/reset-password` , {newPassword, confirmPassword, token, subDomain: "c_master"})
