...
export default function RecoverKeyField() {
      ...
      <div className="mt-5 md:w-[95%] 2xl:w-[70%] mx-auto mb-24 md:mb-0">
        ...
        <div className="block md:hidden px-3 md:px-0">
          <p className="nun font-normal text-[14px] text-[#121F2C] dark:text-white mt-5">
            Define or edit your Key Fields by changing the content in the Value
            field, then Save all changes using the SAVE button at the bottom of
            the screen. Please note - if you make changes and do not click the
            SAVE button, your changes will be lost.
          </p>
          <p className="nun font-normal text-[14px] text-[#121F2C] dark:text-white mt-5 md:border-b-[1px] border-[#EFEFEF99] pb-3">
            This listing includes Key Fields currently available in CU Policies
            and may change as content is added or deleted.
          </p>
        </div>
