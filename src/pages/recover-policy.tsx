...
import RecoverAccordion from "./component/cu-policy/recoverAccordion";
    ...
    <>
      <div className="relative">
        ...
        {!searchActive ? ( // Conditionally render based on searchActive state
          <>
      <div className="bg-[#FFDF36] p-[5px] -mt-1 md:-mt-[12px] xl:-mt-[10px] fixed w-full z-10 md:z-0"></div>
      ...
      <div className="md:flex gap-2 md:mt-5 md:w-[95%] 2xl:w-[70%] mx-auto md:mb-20">
        ...
        <div className="hidden md:block md:w-[65%] lg:w-[60%] md:px-5">
          <RecoverAccordion handleBack={handleBack} />
        </div>
        ...
        <div className="relative block md:hidden">
          ...
          <Link href={"/recover-model"} className="fixed bottom-0 w-full  z-20">
            <button className="absolute bottom-0 w-full block md:hidden font-semibold text-[14px] text-white dark:bg-[#4A9FE7] bg-[#3076B1] hover:bg-[#18459D] md:rounded-[6px] p-[14px]  uppercase">
              import policies
            </button>
          </Link>
        </div>
