    ...
    <div className="bg-[#AD7EFB] p-[5px] -mt-1 md:-mt-[12px] xl:-mt-[10px] fixed w-full"></div>
      ...
      <div className="mt-8 md:mt-5 md:w-[95%] 2xl:w-[70%] mx-auto mb-12 md:mb-10">
        <div className="flex justify-between px-3 md:px-0">
          ...
          <button className="hidden md:block font-semibold text-[14px] text-white dark:bg-[#4A9FE7] bg-[#3076B1] hover:bg-[#18459D] rounded-[6px] py-[14px] px-[10px] uppercase">
            import policies
          </button>
        </div>
        <div className="bg-white dark:bg-black rounded-[7px] shadow-sm mt-5">
          <div className="flex justify-between p-[15px] border-b-[1px] border-[#CCCCCC]">
            ...
            <div className="flex gap-4 self-center">
              <p className="nun font-normal text-[12px] text-[#121212] dark:text-white">
                All Sub-Content
              </p>
              <input type="checkbox" />
            </div>
      ...
      <Link href={'/cu-policies'} className="fixed bottom-0 w-full  z-20" >
          <button className="mt-5 font-semibold text-[14px] text-white bg-[#3076B1] dark:bg-[#4A9FE7] hover:bg-[#18459D] w-full py-[14px] px-[10px] uppercase">
            import policies
          </button>
          </Link>
        </div>
