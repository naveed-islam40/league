          ...
          <>
            ...
            <div className="md:w-[95%] 2xl:w-[70%] mx-auto grid grid-cols-2 md:flex md:justify-end md:mr-12 mt-5 lg:-mt-8">
              <Link href={"/publishDocx"}>
                <button className="dark:bg-[#3c3c3c] dark:text-white w-full md:w-auto bg-white nun font-medium text-[14px] text-[#121212] rounded-tl-[4px] py-[15px] md:py-[10px] px-[30px]">
                  CU PolicyPro
                </button>
              </Link>

              <Link href={"/recover-publish"}>
                <button className="dark:bg-[#242424] dark:text-white w-full md:w-auto bg-[#E5E5E5] nun font-medium text-[14px] text-[#121212] rounded-tr-[4px] py-[15px] md:py-[10px] px-[30px]">
                  RecoveryPro
                </button>
              </Link>
            </div>
