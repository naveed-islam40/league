...
import EditAssignment from "./component/manageAssignment/editAssignment";
...
export default function Ability() {
  ...
  const [activeSection, setActiveSection] = useState<string>("accounts-introduction"); // Set the first section as default active
      ...
      <div className="relative">
        ...
        {!searchActive ? ( // Conditionally render based on searchActive state
          <>
            ...
            <div className="flex md:hidden justify-between mx-3 mt-6">
              <Link
                href={"/a-to-z"}
            ...
            <div className="md:flex gap-2 mt-5 w-[95%] 2xl:w-[70%] mx-auto  mb-20">
              <div className="hidden md:block w-[35%] lg:w-[25%] xl:w-[20%] bg-white dark:bg-black rounded-[8px] p-[10px] shadow-sm h-full">
                <div className="relative">
                  ...
                  placeholder="A to Z Listings"
                    ...
                    className="bg-[#AEE6F566] mt-[0px] rounded-[6px] py-[10px] px-[35px] w-full outline-none"
                  />
                ...
                <div className="mt-3">
                  {filteredItems.map((item, index) => (
                    <div key={index}>
                      {item.link ? (
                        <Link href={item.link}>
                          <p className="font-normal dark:bg-[#242424] text-[#121F2C] dark:text-white text-[14px] py-[12px] px-[16px] cursor-pointer hover:bg-[#eaf1f7] dark:hover:bg-[#0F2B42] rounded-[8px]">
                            {item.name}
                          </p>
                        </Link>
                      ) : (
                        <p className="font-normal dark:bg-[#242424] mt-1 text-[#121F2C] dark:text-white text-[14px] py-[12px] px-[16px] cursor-pointer hover:bg-[#eaf1f7] dark:hover:bg-[#0F2B42] rounded-[8px]">
                          {item.name}
                        </p>
                      )}
                    </div>
              ...
              <div className="md:w-[65%] lg:w-[60%] md:px-5 lg:h-screen lg:pb-64 md:overflow-y-scroll">
                  ...
                  <div className="flex gap-1">
                    ...
                    <div className="relative" ref={locationDropdownRef}>
                      <p
                        ...
                        className="cursor-pointer mt-[2px] md:mt-1 flex gap-1 font-normal text-[11px] text-[#3076B1] self-center"
                      >
                        Change
                ...
                <div className="mt-3" id="accounts-introduction">
                  ...
                  <p className="nun font-normal text-[#121F2C] dark:text-white text-[12px] mt-5">
                    Credit unions that make closed-end consumer loans secured by
                    a dwelling must comply with Consumer Financial Protection
                    Bureau (CFPB)s Ability-to-Repay/Qualified Mortgage (ATR/QM)
                    Rule for loan applications.  When a credit union complies
                    with the Ability to Repay rule and underwrites certain
                    “qualified mortgages,” it has certain protections from legal
                    liability.  The rule requires the credit union to assess a
                    member’s ability to repay for virtually all closed-end
                    residential mortgage loans secured by the member’s dwelling.
                  </p>
                </div>
              ...
              <div className="hidden lg:block w-[25%] xl:w-[20%] sticky">
